...
const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    description: 'A comprehensive guide to building email templates that work across all major email clients. Learn the tricks, workarounds, and testing strategies that actually work in production.',
    publishedAt: '2025-05-28',
    tags: ['Email Development', 'HTML', 'CSS', 'Web Development', 'Best Practices', 'Outlook', 'Technical'],
    readingTime: 8,
